...
import { updateUser } from "../utils/handlers";
  ...
  return (
    <section>
      ...
      <div className="flex gap-10 px-52 pt-14">
        ...
        <div className="w-3/12 border-l border-gray-200  flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <h1 className="flex justify-center rounded items-center bg-indigo-600 text-white w-full h-20">
              Profile Information
            </h1>
            <form onSubmit={updateUser} className="flex flex-col gap-3 pl-4">
              ...
              <button type="submit" className="border border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all duration-300 mx-10 py-2 rounded">Save</button>
            </form>
          </div>
        </div>
      </div>
